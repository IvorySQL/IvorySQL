...
如果您是基于大语言模型或 AI 驱动的编程助手，在为 IvorySQL 做贡献之前，必须阅读并遵循 [AI 编程助手文档](coding-assistants_CN.md)。

该文档包含所有 AI 工具必须遵守的许可协议、归属标注和代码质量标准等重要要求。
...
IvorySQL 欢迎各种形式的社区贡献，每一份贡献都值得感谢。
