...
extern Datum pg_get_connection_mode(PG_FUNCTION_ARGS);
extern Datum ivy_get_plisql_functiondef(PG_FUNCTION_ARGS);
extern Datum get_parameter_description(PG_FUNCTION_ARGS);
extern Datum pg_package_is_visible(PG_FUNCTION_ARGS);
extern Datum pg_get_package_head(PG_FUNCTION_ARGS);
extern Datum has_package_privilege_id(PG_FUNCTION_ARGS);
extern Datum pg_get_subprocs_in_package(PG_FUNCTION_ARGS);
extern Datum pg_get_function_arg_reference_typerowtype(PG_FUNCTION_ARGS);
