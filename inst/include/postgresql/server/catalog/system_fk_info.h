...
static const SysFKRelationship sys_fk_relationships[] = {
	...
	{ /* pg_package */ 9111, /* pg_namespace */ 2615, "{pkgnamespace}", "{oid}", false, false},
	{ /* pg_package */ 9111, /* pg_authid */ 1260, "{pkgowner}", "{oid}", false, false},
	{ /* pg_package_body */ 9106, /* pg_package */ 9111, "{pkgoid}", "{oid}", false, false},
};
