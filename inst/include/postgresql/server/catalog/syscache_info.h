...
static const struct cachedesc cacheinfo[] = {
	...
	[FORCEVIEWOID] = {
		ForceViewRelationId,
		ForceViewFvoidIndexId,
		KEY(Anum_pg_force_view_fvoid),
		16
	},
	...
	[PKGBODYOID] = {
		...
		KEY(Anum_pg_package_body_oid),
		8
	},
	[PKGBODYPKGOID] = {
		PackageBodyRelationId,
		PackageBodyPkgOidIndex,
		KEY(Anum_pg_package_body_pkgoid),
		8
	},
	[PKGNAMEARGSNSP] = {
		PackageRelationId,
		PackageNameArgsNspIndexId,
		KEY(Anum_pg_package_pkgname, Anum_pg_package_pkgnamespace),
		8
	},
	[PKGOID] = {
		PackageRelationId,
		PackageObjectIndexId,
		KEY(Anum_pg_package_oid),
		8
	},
	[PROCNAMEARGSNSP] = {
		ProcedureRelationId,
