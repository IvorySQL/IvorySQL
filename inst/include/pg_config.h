...
#define CONFIGURE_ARGS " '--prefix=/home/xiaoyu/IvorySQL/inst' '--enable-debug' '--with-openssl' '--without-uuid-ossp' '--without-perl' '--without-python' '--without-tcl' '--without-gssapi' '--without-pam' '--without-ldap'"
...
#define DEF_ORAPORT 1521

#define DEF_ORAPORT_STR "1521"
...
/* Set maximum number of function arguments. */
#define MAXIMUM_FUNARG 100
...
#define PACKAGE_IVORYSQL_VERSION "5beta1"

/* A string containing the version number, platform, and C compiler */
#define PG_VERSION_STR "PostgreSQL 18beta1 (IvorySQL 5beta1) on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 13.3.0-6ubuntu2~24.04.1) 13.3.0, 64-bit"
