...
ALTER TABLE pg_package ADD PRIMARY KEY USING INDEX pg_package_oid_index;

ALTER TABLE pg_package ADD UNIQUE USING INDEX pg_package_pkgname_nsp_index;

ALTER TABLE pg_package_body ADD PRIMARY KEY USING INDEX pg_package_body_oid_index;

ALTER TABLE pg_package_body ADD UNIQUE USING INDEX pg_package_body_pkgoid_index;

ALTER TABLE pg_force_view ADD PRIMARY KEY USING INDEX pg_force_view_fvoid_index;
