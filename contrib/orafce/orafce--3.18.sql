...
/*
CREATE FUNCTION oracle.ncharcat(oracle.nchar, oracle.nvarchar)
RETURNS text
AS 'select textcat($1::text, $2::text)'
LANGUAGE SQL IMMUTABLE;

CREATE OPERATOR oracle.|| (procedure = oracle.ncharcat, leftarg = oracle.nchar, rightarg = oracle.nvarchar);
*/
