...
-- ******************************
DELETE FROM num_result;
INSERT INTO num_result SELECT id, 0, LOG(number '10', ABS(val))
    FROM num_data
    WHERE val != '0.0';
SELECT t1.id1, t1.result, t2.expected
...
WITH v(x) AS
  (VALUES('0'::number),('1'),('-1'),('4.2'),('inf'),('-inf'),('nan'))
SELECT x1, x2,
  x1 + x2 AS sum,
  x1 - x2 AS diff,
  x1 * x2 AS prod
...
SELECT 'nan'::number % '0';
SELECT '0'::number % '0';
SELECT div('inf'::number, '0');
SELECT div('-inf'::number, '0');
SELECT div('nan'::number, '0');
SELECT div('0'::number, '0');

WITH v(x) AS
  (VALUES('0'::number),('1'),('-1'),('4.2'),('-7.777'),('inf'),('-inf'),('nan'))
SELECT x, -x as minusx, abs(x), floor(x), ceil(x), sign(x), number_inc(x) as inc
FROM v;
...
-- the large values fall into the number abbreviation code's maximal classes
WITH v(x) AS
  (VALUES('0'::number),('1'),('-1'),('4.2'),('-7.777'),('1e340'),('-1e340'),
         ('inf'),('-inf'),('nan'),
         ('inf'),('-inf'),('nan'))
...
WITH v(x) AS
  (VALUES('0'::number),('1'),('4.2'),('inf'),('nan'))
SELECT x, sqrt(x)
FROM v;

SELECT sqrt('-1'::number);
SELECT sqrt('-inf'::number);

WITH v(x) AS
  (VALUES('1'::number),('4.2'),('inf'),('nan'))
SELECT x,
  log(x),
  log10(x),
  ln(x)
...
SELECT ln('0'::number);
SELECT ln('-1'::number);
SELECT ln('-inf'::number);

WITH v(x) AS
  (VALUES('2'::number),('4.2'),('inf'),('nan'))
SELECT x1, x2,
  log(x1, x2)
FROM v AS v1(x1), v AS v2(x2);

SELECT log('0'::number, '10');
SELECT log('10'::number, '0');
SELECT log('-inf'::number, '10');
SELECT log('10'::number, '-inf');
SELECT log('inf'::number, '0');
SELECT log('inf'::number, '-inf');
SELECT log('-inf'::number, 'inf');

WITH v(x) AS
  (VALUES('0'::number),('1'),('2'),('4.2'),('inf'),('nan'))
SELECT x1, x2,
  power(x1, x2)
FROM v AS v1(x1), v AS v2(x2) WHERE x1 != 0 OR x2 >= 0;

SELECT power('0'::number, '-1');
SELECT power('0'::number, '-inf');
SELECT power('-1'::number, 'inf');
SELECT power('-2'::number, '3');
SELECT power('-2'::number, '3.3');
SELECT power('-2'::number, '-1');
SELECT power('-2'::number, '-1.5');
SELECT power('-2'::number, 'inf');
SELECT power('-2'::number, '-inf');
SELECT power('inf'::number, '-2');
SELECT power('inf'::number, '-inf');
SELECT power('-inf'::number, '2');
SELECT power('-inf'::number, '3');
SELECT power('-inf'::number, '4.5');
SELECT power('-inf'::number, '-2');
SELECT power('-inf'::number, '-3');
SELECT power('-inf'::number, '0');
SELECT power('-inf'::number, 'inf');
SELECT power('-inf'::number, '-inf');
...
SELECT 'NaN'::float8::number;
SELECT 'Infinity'::float8::number;
SELECT '-Infinity'::float8::number;
SELECT 'NaN'::number::float8;
SELECT 'Infinity'::number::float8;
SELECT '-Infinity'::number::float8;
SELECT 'NaN'::float4::number;
SELECT 'Infinity'::float4::number;
SELECT '-Infinity'::float4::number;
SELECT 'NaN'::number::float4;
SELECT 'Infinity'::number::float4;
SELECT '-Infinity'::number::float4;
SELECT '42'::int2::number;
SELECT 'NaN'::number::int2;
SELECT 'Infinity'::number::int2;
SELECT '-Infinity'::number::int2;
SELECT 'NaN'::number::int4;
SELECT 'Infinity'::number::int4;
SELECT '-Infinity'::number::int4;
SELECT 'NaN'::number::int8;
SELECT 'Infinity'::number::int8;
SELECT '-Infinity'::number::int8;
...
SELECT i as pow,
	round((-2.5 * 10 ^ i)::number, -i),
	round((-1.5 * 10 ^ i)::number, -i),
	round((-0.5 * 10 ^ i)::number, -i),
	round((0.5 * 10 ^ i)::number, -i),
	round((1.5 * 10 ^ i)::number, -i),
	round((2.5 * 10 ^ i)::number, -i)
...
SELECT width_bucket(0.0::number, 'Infinity'::number, 5, 10); -- error
SELECT width_bucket(0.0::number, 5, '-Infinity'::number, 20); -- error
SELECT width_bucket('Infinity'::number, 1, 10, 10),
       width_bucket('-Infinity'::number, 1, 10, 10);
...
WITH v(val) AS
  (VALUES('0'::number),('-4.2'),('4.2e9'),('1.2e-5'),('inf'),('-inf'),('nan'))
SELECT val,
  to_char(val, '9.999EEEE') as number,
...
SELECT exp,
  to_char(('1.2345e'||exp)::number, '9.999EEEE') as number
FROM v;

WITH v(val) AS
  (VALUES('0'::number),('-4.2'),('4.2e9'),('1.2e-5'),('inf'),('-inf'),('nan'))
SELECT val,
  to_char(val, 'MI9999999999.99') as number,
...
WITH v(val) AS
  (VALUES('0'::number),('-4.2'),('4.2e9'),('1.2e-5'),('inf'),('-inf'),('nan'))
SELECT val,
  to_char(val, 'MI99.99') as number,
  to_char(val::float8, 'MI99.99') as float8,
  to_char(val::float4, 'MI99.99') as float4
FROM v;

SELECT to_char('100'::number, 'FM999.9');
SELECT to_char('100'::number, 'FM999.');
SELECT to_char('100'::number, 'FM999');

-- Check parsing of literal text in a format string
SELECT to_char('100'::number, 'foo999');
SELECT to_char('100'::number, 'f\oo999');
SELECT to_char('100'::number, 'f\\oo999');
SELECT to_char('100'::number, 'f\"oo999');
SELECT to_char('100'::number, 'f\\"oo999');
SELECT to_char('100'::number, 'f"ool"999');
SELECT to_char('100'::number, 'f"\ool"999');
SELECT to_char('100'::number, 'f"\\ool"999');
SELECT to_char('100'::number, 'f"ool\"999');
SELECT to_char('100'::number, 'f"ool\\"999');
...
select sqrt(1.000000000000003::number);
select sqrt(1.000000000000004::number);
select sqrt(96627521408608.56340355805::number);
select sqrt(96627521408608.56340355806::number);
select sqrt(515549506212297735.073688290367::number);
select sqrt(515549506212297735.073688290368::number);
select sqrt(8015491789940783531003294973900306::number);
select sqrt(8015491789940783531003294973900307::number);
...
select exp(0.0);
select exp(1.0);
select exp(1.0::number(71,70));
select exp('nan'::number);
select exp('inf'::number);
select exp('-inf'::number);
select coalesce(nullif(exp(-5000::number), 0), 0) as rounds_to_zero;
select coalesce(nullif(exp(-10000::number), 0), 0) as underflows;
...
select * from generate_series('inf'::number, 'inf'::number, 10::number);
select * from generate_series(0::number, 'inf'::number, 10::number);
select * from generate_series(0::number, '42'::number, '-inf'::number);
...
select scale(number 'NaN');
select scale(number 'inf');
select scale(NULL::number);
select scale(1.12);
select scale(0);
select scale(0.00);
...
select min_scale(number 'NaN') is NULL; -- should be true
select min_scale(number 'inf') is NULL; -- should be true
...
select trim_scale(number 'NaN');
select trim_scale(number 'inf');
...
SELECT SUM(9999::number) FROM generate_series(1, 100000);
SELECT SUM((-9999)::number) FROM generate_series(1, 100000);
...
FROM (VALUES (0::number, 0::number),
             (0::number, number 'NaN'),
             (0::number, 46375::number),
             (433125::number, 46375::number),
             (43312.5::number, 4637.5::number),
             (4331.250::number, 463.75000::number),
             ('inf', '0'),
             ('inf', '42'),
             ('inf', 'inf')
     ) AS v(a, b);
...
FROM (VALUES (0::number, 0::number),
             (0::number, number 'NaN'),
             (0::number, 13272::number),
             (13272::number, 13272::number),
             (423282::number, 13272::number),
             (42328.2::number, 1327.2::number),
             (4232.820::number, 132.72000::number),
             ('inf', '0'),
             ('inf', '42'),
             ('inf', 'inf')
     ) AS v(a, b);

SELECT lcm(9999 * (10::number)^131068 + (10::number^131068 - 1), 2); -- overflow
...
-- Tests for pg_lsn()
--
SELECT pg_lsn(23783416::number);
SELECT pg_lsn(0::number);
SELECT pg_lsn(18446744073709551615::number);
SELECT pg_lsn(-1::number);
SELECT pg_lsn(18446744073709551616::number);
SELECT pg_lsn('NaN'::number);

--
--test for number(p, s) (s < 0)
--
select 1234.4343::oracle.number(12,-1);
select 1234.4343::oracle.number(12,-2);
select 1234.4343::oracle.number(12,-3);
select 1234.4343::oracle.number(12,-4);

--
--test for number(*,s)
--
select 1234567.89::number(*,2);
select 1234567.89::number(*,1);
select 1234567.89::oracle.number(*,1);
select 1234567.89::oracle.number(*,2);
select 1234567.89::oracle.number(*,-2);
select 0.101::oracle.number(*,39);
select 0.01::oracle.number(*,39);

--
--test for number(p,s) (s < p)
--
select 0.000000000000000000000000000000000000001::oracle.number(*,76);
select 0.000000000000000000000000000000000000001::oracle.number(*,77);
select 0.00000000000000000000000000000000001::oracle.number(2,38);

--
--others
--
select cast(0.012 as number(2,3)) from dual;
select cast(0.012 as number(6,3)) from dual;
select cast(0.12 as number(2,2)) from dual;
select cast(0.001000000001 as number(2,4)) from dual;
select cast (0.00001 as number(3,7)) from dual;
select cast (0.00011 as number(3,7)) from dual;
select cast(0.0001 as number(6,5)) from dual;
select cast(0.0101 as number(6,5)) from dual;
select cast(0.0001 as number(2,5)) from dual;
select cast(120.0001 as number(10,6)) from dual;
select cast(-0.5000000000000000 as number(*,20)) from dual;
select cast(-8.0000000000000000 as number(*,20)) from dual;
