...
-- insert into cth values(DEFAULT,'test1','01 Mar 2003','test_startdate','28 February 2003');
insert into cth values(DEFAULT,'test1','01 Mar 2003','volts','2.6987');
insert into cth values(DEFAULT,'test2','02 Mar 2003','temperature','53');
insert into cth values(DEFAULT,'test2','02 Mar 2003','test_result','FAIL');
insert into cth values(DEFAULT,'test2','02 Mar 2003','test_startdate','01 March 2003');
insert into cth values(DEFAULT,'test2','02 Mar 2003','volts','3.1234');
-- next group tests for NULL rowids
insert into cth values(DEFAULT,NULL,'25 Oct 2007','temperature','57');
insert into cth values(DEFAULT,NULL,'25 Oct 2007','test_result','PASS');
insert into cth values(DEFAULT,NULL,'25 Oct 2007','test_startdate','24 October 2007');
insert into cth values(DEFAULT,NULL,'25 Oct 2007','volts','1.41234');
...
create type my_crosstab_result as (
  rowid text, rowdt pg_catalog.timestamp,
  temperature int4, test_result text, test_startdate pg_catalog.timestamp, volts float8);

CREATE FUNCTION crosstab_named(pg_catalog.text, pg_catalog.text)
