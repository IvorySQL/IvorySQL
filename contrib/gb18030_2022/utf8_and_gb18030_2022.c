 ...
 *
 * Abstract:
 * 		This file was extract from src/backend/utils/mb/conversion_procs/utf8_and_gb18030.c 
 * 		to support encoding conversion between gb18030_2022 and utf8 using radix tree in ./Maps/\*.map.
 *
 * Authored by huawenbo@highgo.com, 20231024.
 *
 * Copyright:
