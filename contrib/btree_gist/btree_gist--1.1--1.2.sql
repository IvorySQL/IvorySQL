...
('gbt_ts_distance(internal,pg_catalog.timestamp,int2,oid)', '{internal,pg_catalog.timestamp,int2,oid,internal}'),
('gbt_tstz_distance(internal,pg_catalog.timestamptz,int2,oid)', '{internal,pg_catalog.timestamptz,int2,oid,internal}'),
...
('gbt_time_distance(internal,pg_catalog.time,int2,oid)', '{internal,pg_catalog.time,int2,oid,internal}'),
...
('gbt_date_distance(internal,pg_catalog.date,int2,oid)', '{internal,pg_catalog.date,int2,oid,internal}'),
...
('gbt_intv_distance(internal,pg_catalog.interval,int2,oid)', '{internal,pg_catalog.interval,int2,oid,internal}'),
