 ...
 *
 * NULL behaviour is intentionally NOT strict: it replicates the
 * behaviour of a real Oracle database, which differs per function
 * (verified on Oracle Database 19c):
 *
