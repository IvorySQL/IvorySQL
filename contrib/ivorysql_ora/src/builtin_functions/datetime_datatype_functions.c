/*-------------------------------------------------------------------------------
 * 
 * File: datetime_datatype_functions.c
 *
 * Abstract: 
...
static const WeekDays WEEKDAYS[] =
{
	...
	{ PG_UTF8, { "\xe6\x98\x9f\xe6\x9c\x9f\xe6\x97\xa5", "\xe6\x98\x9f\xe6\x9c\x9f\xe4\xb8\x80", "\xe6\x98\x9f\xe6\x9c\x9f\xe4\xba\x8c", "\xe6\x98\x9f\xe6\x9c\x9f\xe4\xb8\x89", "\xe6\x98\x9f\xe6\x9c\x9f\xe5\x9b\x9b", "\xe6\x98\x9f\xe6\x9c\x9f\xe4\xba\x94", "\xe6\x98\x9f\xe6\x9c\x9f\xe5\x85\xad" } },
	
	
	{ PG_GBK, { "\320\307\306\332\310\325", "\320\307\306\332\322\273", "\320\307\306\332\266\376", "\320\307\306\332\310\375", "\320\307\306\332\313\304", "\320\307\306\332\316\345", "\320\307\306\332\301\371" } }
};
...
oradsinterval_to_char1(PG_FUNCTION_ARGS)
{
	...
	char *aa;
	VarChar	*vres;
	aa = DatumGetCString(DirectFunctionCall1(dsinterval_out,IntervalPGetDatum(intervaldate)));
...
orayminterval_to_char1(PG_FUNCTION_ARGS)
{
	...
	char *aa;
	VarChar	*vres;
	aa = DatumGetCString(DirectFunctionCall1(yminterval_out,IntervalPGetDatum(intervaldate)));
