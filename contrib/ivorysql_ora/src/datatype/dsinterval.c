...
static int
tm2dsinterval(struct pg_tm * tm, fsec_t fsec, Interval *span)
{
...
dsinterval_in(PG_FUNCTION_ARGS)
{
	...
	while (*strold != '\0')
	{
		...
		/* Begin - describe: "interval '2 6: 23' day to minute"
		 * and "interval '2 6:16: 23' day to second" should be support
		 */
