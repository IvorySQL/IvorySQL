...
SELECT
    PGSA.PID AS SID,
    PGSA.USENAME AS USERNAME,
    PGSA.STATE AS STATUS,
    PGSA.CLIENT_ADDR AS MACHINE,
    PGSA.APPLICATION_NAME AS PROGRAM,
    PGSA.BACKEND_TYPE AS TYPE,
    PGSA.BACKEND_START AS LOGON_TIME,
    PGSA.QUERY AS SQL_TEXT,
    PGSA.WAIT_EVENT AS EVENT,
    PGSA.XACT_START AS TRANSACTION_START,
    PGSA.CLIENT_PORT AS PORT
