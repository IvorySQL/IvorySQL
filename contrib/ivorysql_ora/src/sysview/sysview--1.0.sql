...
WITH BLOCKS AS
(
        SELECT BLOCKING.PID::NUMBER AS BLOCKING_PID,
               BLOCKED.PID::NUMBER AS BLOCKED_PID
...
SELECT
    ...
    BACKEND_TYPE::VARCHAR2(30) AS TYPE,
    BACKEND_START AS LOGON_TIME,
    QUERY_START AS SQL_EXEC_START,
    QUERY_ID::VARCHAR2(19) AS SQL_ID,
    QUERY::VARCHAR2(4000) AS SQL_TEXT,
    CASE WHEN BLOCKS.BLOCKED_PID = PG_STAT_ACTIVITY.PID THEN BLOCKS.BLOCKING_PID
         ELSE NULL
    END::NUMBER AS BLOCKING_SESSION,
...
FROM PG_STAT_ACTIVITY
     LEFT JOIN BLOCKS
     ON BLOCKS.BLOCKED_PID = PG_STAT_ACTIVITY.PID;
...
/* GRANT SELECT PRIVILEGE TO PUBLIC */
GRANT SELECT ON SYS.V$PROCESS TO PUBLIC;
