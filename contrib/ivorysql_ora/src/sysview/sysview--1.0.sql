...
SELECT
    ...
    CASE WHEN ATT.ATTNOTNULL THEN 'N' ELSE 'Y' END AS NULLABLE,
    FORMAT_TYPE(ATT.ATTTYPID, ATT.ATTTYPMOD)::VARCHAR2(128) AS DATA_TYPE,
    ATT.ATTLEN AS DATA_LENGTH,
    NULL AS DATA_PRECISION,
    NULL AS DATA_SCALE,
    NULL AS NULLABLE_COLUMN_ID,
    CURRENT_TIMESTAMP AS LAST_DDL_TIMESTAMP,
    NULL::VARCHAR2(128) AS CHARACTER_SET_NAME,
    NULL::VARCHAR2(128) AS DATA_TYPE_MOD,
    NULL AS DATA_TYPE_OWNER,
    NULL::VARCHAR2(128) AS DATA_TYPE_LINK,
    ...
    NULL AS ANALYZED,
    NULL AS SAMPLE_SIZE,
    NULL AS CHAR_COL_DECL_LENGTH,
    NULL::VARCHAR2(128) AS GLOBAL_STATS,
    NULL::VARCHAR2(128) AS USER_STATS,
    NULL AS AVG_COL_LEN,
    NULL AS CHAR_LENGTH,
    NULL AS CHAR_USED,
    NULL::VARCHAR2(128) AS V80_FMT_IMAGE,
    NULL::VARCHAR2(128) AS DATA_UPGRADED,
    NULL AS HISTOGRAM,
    NULL::VARCHAR2(128) AS IDENTITY_COLUMN,
    NULL::VARCHAR2(128) AS SEGMENT_CREATED,
    NULL::VARCHAR2(128) AS LOB_FORMAT,
    NULL::VARCHAR2(128) AS LOB_PRECISION,
    NULL AS LOB_LENGTH,
    NULL::VARCHAR2(128) AS NESTED,
    NULL::VARCHAR2(128) AS HIDDEN_COLUMN,
    NULL::VARCHAR2(128) AS VIRTUAL_COLUMN,
    NULL AS SEGMENT_ID,
    NULL::VARCHAR2(128) AS CONTAINER_DATA,
    NULL::VARCHAR2(128) AS UNUSED_COLUMN,
    NULL::VARCHAR2(128) AS SENSITIVE_COLUMN
FROM
    PG_CLASS C
