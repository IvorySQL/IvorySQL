...
SELECT
    ...
    CASE WHEN ATT.ATTTYPID IN (20,21,23) THEN ATT.ATTLEN END AS DATA_PRECISION,
    CASE WHEN ATT.ATTTYPMOD > 0 THEN (ATT.ATTTYPMOD - 4) END AS DATA_SCALE,
    ...
    CASE WHEN ATT.ATTTYPID IN (1042,1043) THEN (ATT.ATTTYPMOD - 4) END AS CHAR_COL_DECL_LENGTH,
    NULL AS GLOBAL_STATS,
    NULL AS USER_STATS,
    NULL AS AVG_COL_LEN,
    CASE WHEN ATT.ATTTYPID IN (1042,1043) THEN (ATT.ATTTYPMOD - 4) END AS CHAR_LENGTH,
    CASE WHEN ATT.ATTTYPID IN (1042,1043) THEN 'C' END AS CHAR_USED,
    ...
    NULL AS COLLATION_OWNER,
    NULL AS IDENTITY_COLUMN,
    NULL AS SEGMENT_CREATED,
    NULL AS LOB_FORMAT,
    NULL AS LOB_PRECISION,
    NULL AS LOB_LENGTH,
    NULL AS NESTED,
    NULL AS HIDDEN_COLUMN,
    NULL AS VIRTUAL_COLUMN,
    NULL AS SEGMENT_ID,
    NULL AS SENSITIVE_COLUMN
FROM PG_CLASS C
