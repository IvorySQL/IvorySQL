...
SELECT
    PGSA.PID::NUMBER AS SID,
    PGSA.USENAME::VARCHAR2(128) AS USERNAME,
    PGSA.STATE::VARCHAR2(30) AS STATUS,
    PGSA.CLIENT_ADDR::VARCHAR2(128) AS MACHINE,
    PGSA.APPLICATION_NAME::VARCHAR2(256) AS PROGRAM,
    PGSA.BACKEND_TYPE::VARCHAR2(30) AS TYPE,
    PGSA.BACKEND_START AS LOGON_TIME,
    PGSA.QUERY::VARCHAR2(4000) AS SQL_TEXT,
    PGSA.WAIT_EVENT::VARCHAR2(64) AS EVENT,
    PGSA.XACT_START AS TRANSACTION_START,
    PGSA.CLIENT_PORT::NUMBER AS PORT
FROM PG_STAT_ACTIVITY PGSA;

/* GRANT SELECT PRIVILEGE TO PUBLIC */
GRANT SELECT ON SYS.V$SESSION TO PUBLIC;
