...
-- we should avoid implementing "killing by SID" without either an additional counter or second factor like PG_STAT_ACTIVITY.START.
...
SELECT
    ...
    CLIENT_HOSTNAME::VARCHAR2(128) AS MACHINE,
    ...
    CASE WHEN CARDINALITY((PG_BLOCKING_PIDS(PID))) > 0 THEN (PG_BLOCKING_PIDS(PID))[1]
         ELSE NULL
