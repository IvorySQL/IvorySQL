...
-- (DEFERRABLE is a keyword in oracle mode, so qualify the column)
SELECT CONSTRAINT_NAME, CONSTRAINT_TYPE, R_OWNER,
	R_CONSTRAINT_NAME, DELETE_RULE, STATUS, UC.DEFERRABLE, DEFERRED, VALIDATED
...
SELECT STATUS, UC.DEFERRABLE, DEFERRED, VALIDATED, GENERATED, BAD, RELY,
