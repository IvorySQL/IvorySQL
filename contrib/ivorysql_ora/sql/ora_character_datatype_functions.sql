...
select length('192') from dual;
select length('IvorySQL DB!') from dual;
select length('今天') from dual;
select length(cast('IvorySQL DB!' as char(10))) from dual;
select length(cast('IvorySQL DB!' as char(20))) from dual;
select length(cast('IvorySQL DB!' as varchar(20))) from dual;
select length(cast('IvorySQL DB!' as oravarcharchar(20))) from dual;
select length(cast('IvorySQL DB!' as oravarcharchar(20))) from dual;
select length(cast('IvorySQL DB!' as text)) from dual;
...
select lengthb('192') from dual;
select lengthb('IvorySQL DB!') from dual;
select lengthb('今天') from dual;
select lengthb(cast('IvorySQL DB!' as char(10))) from dual;
select lengthb(cast('IvorySQL DB!' as char(20))) from dual;
select lengthb(cast('IvorySQL DB!' as varchar(20))) from dual;
select lengthb(cast('IvorySQL DB!' as varchar2(20))) from dual;
--select lengthb('IvorySQL DB!'::nvarchar2(20)) from dual;
select lengthb(cast('IvorySQL DB!' as text)) from dual;
