...
-- An empty nlsparam must not skip timestamp parsing.
select sys.to_timestamp('2022-08-23 15:26:37.123456',
						'YYYY-MM-DD HH24:MI:SS.FF',
						pg_catalog.repeat('x', 0)) =
	   sys.to_timestamp('2022-08-23 15:26:37.123456',
						'YYYY-MM-DD HH24:MI:SS.FF')
from dual;

select sys.to_timestamp_tz('2022-08-23 15:26:37.123456 +08:00',
						   'YYYY-MM-DD HH24:MI:SS.FF TZH:TZM',
						   pg_catalog.repeat('x', 0)) =
	   sys.to_timestamp_tz('2022-08-23 15:26:37.123456 +08:00',
						   'YYYY-MM-DD HH24:MI:SS.FF TZH:TZM')
from dual;
