...
--
-- Regression content kept consistent with PostgreSQL commit 89f908a6d0
-- ("Add temporal FOREIGN KEY contraints", src/test/regress/sql/without_overlaps.sql).
--
...
ALTER TABLE temporal_fk_rng2rng
  ...
  REFERENCES temporal_rng;
ALTER TABLE temporal_fk_rng2rng
  ALTER COLUMN valid_at TYPE daterange USING daterange(lower(valid_at)::pg_catalog.date, upper(valid_at)::pg_catalog.date);
