...
-- Verify bigint TO_DATE wrappers inherit STABLE volatility from the text
-- overloads they call (date parsing depends on session NLS settings).
SELECT count(*) = 2 AS to_date_bigint_stable_ok
