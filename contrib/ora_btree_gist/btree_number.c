/*
 * contrib/ora_btree_gist/btree_number.c
 */
#include "postgres.h"
...
** Bytea ops
*/
PG_FUNCTION_INFO_V1(gbt_number_compress);
PG_FUNCTION_INFO_V1(gbt_number_union);
PG_FUNCTION_INFO_V1(gbt_number_picksplit);
PG_FUNCTION_INFO_V1(gbt_number_consistent);
PG_FUNCTION_INFO_V1(gbt_number_penalty);
PG_FUNCTION_INFO_V1(gbt_number_same);
...
Datum
gbt_number_compress(PG_FUNCTION_ARGS)
{
...
Datum
gbt_number_consistent(PG_FUNCTION_ARGS)
{
	GISTENTRY  *entry = (GISTENTRY *) PG_GETARG_POINTER(0);
...
Datum
gbt_number_union(PG_FUNCTION_ARGS)
{
...
Datum
gbt_number_same(PG_FUNCTION_ARGS)
{
...
Datum
gbt_number_penalty(PG_FUNCTION_ARGS)
{
...
Datum
gbt_number_picksplit(PG_FUNCTION_ARGS)
{
	GistEntryVector *entryvec = (GistEntryVector *) PG_GETARG_POINTER(0);
