...
SELECT '1 hour'::pg_catalog.interval::citext = '1 hour'::pg_catalog.interval::text AS t;
SELECT '1 hour'::citext::pg_catalog.interval = '1 hour'::pg_catalog.interval AS t;
...
INSERT INTO caster (text)          VALUES ('f'::pg_catalog.char);
INSERT INTO caster (chr)           VALUES ('f'::citext);  -- requires cast
INSERT INTO caster (chr)           VALUES ('f'::citext::text);
INSERT INTO caster (citext)        VALUES ('f'::pg_catalog.char);
...
INSERT INTO caster (text)          VALUES ('1 hour'::pg_catalog.interval);
INSERT INTO caster (interval)      VALUES ('1 hour'::citext);
INSERT INTO caster (citext)        VALUES ('1 hour'::pg_catalog.interval);
...
INSERT INTO try
VALUES ( to_char(  now()::timestamp with time zone,          'HH12:MI:SS') ),
       ( to_char(  now() + '1 sec'::pg_catalog.interval, 'HH12:MI:SS') ), -- timestamptz
       ( to_char(  '15h 2m 12s'::pg_catalog.interval,    'HH24:MI:SS') ),
