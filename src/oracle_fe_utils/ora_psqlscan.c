...
case 4:
YY_RULE_SETUP
#line 439 "ora_psqlscan.l"
{
					ECHO;
					if (cur_state->xcdepth <= 0)
					{
						cur_state->xcstate = false;
						BEGIN(INITIAL);
					}
					else
						cur_state->xcdepth--;
...
case 94:
YY_RULE_SETUP
#line 1163 "ora_psqlscan.l"
YY_FATAL_ERROR( "flex scanner jammed" );
	YY_BREAK
#line 4204 "ora_psqlscan.c"
