...
create function returnssetofholes() returns setof has_hole language plisql as
$$
declare r record;
  h has_hole;
begin
...
create function sillytrig() returns trigger language plisql as
$$begin
...
create or replace function sillytrig() returns trigger language plisql as
$$begin
  return row(new.*);
end$$;
/
