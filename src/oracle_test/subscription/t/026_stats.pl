...
is( $node_subscriber->safe_psql(
	...
	qq(t|t|t|t),
	qq(Check that apply errors, sequencesync errors, tablesync errors, and stats_reset is NULL for subscription '$sub1_name'.)
);
...
is( $node_subscriber->safe_psql(
	...
	qq(t|t|t|t),
	qq(Confirm that apply errors, sequencesync errors, tablesync errors, and stats_reset is not NULL after reset for subscription '$sub1_name'.)
);
...
is( $node_subscriber->safe_psql(
	...
	qq(t|t|t|t),
	qq(Confirm that apply errors, sequencesync errors, tablesync errors, and stats_reset is NULL for sub '$sub2_name'.)
);
...
is( $node_subscriber->safe_psql(
	...
	qq(t|t|t|t),
	qq(Confirm that apply errors, sequencesync errors, tablesync errors, and stats_reset is not NULL for sub '$sub1_name' after reset.)
);
...
is( $node_subscriber->safe_psql(
	...
	qq(t|t|t|t),
	qq(Confirm that apply errors, sequencesync errors, tablesync errors, errors, and stats_reset is not NULL for sub '$sub2_name' after reset.)
);
