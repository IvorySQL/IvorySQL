...
sub test_streaming
{
	...
	SAVEPOINT s1;
	INSERT INTO test_tab VALUES (4, sha256(3::text::bytea));
	SAVEPOINT s2;
	INSERT INTO test_tab VALUES (5, sha256(3::text::bytea));
	SAVEPOINT s3;
	INSERT INTO test_tab VALUES (6, sha256(3::text::bytea));
	ROLLBACK TO s2;
	INSERT INTO test_tab VALUES (7, sha256(3::text::bytea));
	ROLLBACK TO s1;
	INSERT INTO test_tab VALUES (8, sha256(3::text::bytea));
	SAVEPOINT s4;
	INSERT INTO test_tab VALUES (9, sha256(3::text::bytea));
	SAVEPOINT s5;
	INSERT INTO test_tab VALUES (10, sha256(3::text::bytea));
	COMMIT;
	});
	...
	SAVEPOINT s1;
	INSERT INTO test_tab VALUES (12, sha256(11::text::bytea));
	SAVEPOINT s2;
	INSERT INTO test_tab VALUES (13, sha256(11::text::bytea));
	SAVEPOINT s3;
	INSERT INTO test_tab VALUES (14, sha256(11::text::bytea));
	RELEASE s2;
	INSERT INTO test_tab VALUES (15, sha256(11::text::bytea));
	ROLLBACK TO s1;
	COMMIT;
	});
	...
	SAVEPOINT s1;
	INSERT INTO test_tab VALUES (17, sha256(16::text::bytea));
	SAVEPOINT s2;
	INSERT INTO test_tab VALUES (18, sha256(16::text::bytea));
	ROLLBACK;
	});
