...
WHERE j1.b = j2.b
  AND j1.a = (PGEXTRACT(DOW FROM current_timestamp(0))/15 + 3)::int
  AND (PGEXTRACT(DOW FROM current_timestamp(0))/15 + 3)::int = j2.a;
-- Return one row
SELECT * FROM sj j1, sj j2
WHERE j1.b = j2.b
  AND j1.a = (PGEXTRACT(DOW FROM current_timestamp(0))/15 + 3)::int
...
SELECT * FROM sj j1, sj j2
WHERE j1.b = j2.b
  AND (j1.a*j1.a) = (PGEXTRACT(DOW FROM current_timestamp(0))/15 + 3)::int
  AND (PGEXTRACT(DOW FROM current_timestamp(0))/15 + 3)::int = (j2.a*j2.a);
