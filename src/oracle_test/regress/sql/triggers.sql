...
--
create or replace function dump_update_new() returns trigger language plisql as
$$
  begin
...
create or replace function dump_update_old() returns trigger language plisql as
$$
  begin
