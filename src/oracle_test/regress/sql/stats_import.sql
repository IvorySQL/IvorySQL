...
SELECT pg_catalog.pg_restore_extended_stats(
  ...
  'most_common_vals', '{{four,NULL},
                        {one,"(1,1.1,ONE,2001-01-01,\"{\"\"xkey\"\": \"\"xval\"\"}\")"},
                        {tre,"(3,3.3,TRE,2003-03-03,)"},
                        {two,"(2,2.2,TWO,2002-02-02,\"[true, 4, \"\"six\"\"]\")"}}'::text[],
...
SELECT pg_catalog.pg_restore_extended_stats(
  ...
  'most_common_vals', '{{four,NULL,0,NULL},
                        {one,"(1,1.1,ONE,2001-01-01,\"{\"\"xkey\"\": \"\"xval\"\"}\")",1,2},
                        {tre,"(3,3.3,TRE,2003-03-03,)",-1,3},
                        {two,"(2,2.2,TWO,2002-02-02,\"[true, 4, \"\"six\"\"]\")",1,2}}'::text[],
  'most_common_freqs', '{0.25,0.25,0.25,0.25}'::double precision[],
