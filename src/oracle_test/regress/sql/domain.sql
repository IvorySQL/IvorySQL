...
-- Check that domain constraints on plisql function parameters, results,
...
--
-- Check enforcement of domain-related typmod in plisql (bug #5717)
--
...
--
-- Check enforcement of changing constraints in plisql
--
