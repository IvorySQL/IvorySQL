...
-- MINUS is Oracle's spelling of EXCEPT (Oracle 21c also accepts MINUS ALL)
SELECT q2 FROM int8_tbl MINUS SELECT q1 FROM int8_tbl ORDER BY 1;
SELECT q2 FROM int8_tbl MINUS ALL SELECT q1 FROM int8_tbl ORDER BY 1;
SELECT q1 FROM int8_tbl MINUS SELECT q2 FROM int8_tbl ORDER BY 1;
SELECT q1 FROM int8_tbl MINUS ALL SELECT q2 FROM int8_tbl ORDER BY 1;
SELECT q2 FROM int8_tbl MINUS DISTINCT SELECT q1 FROM int8_tbl ORDER BY 1;
...
(SELECT 1,2,3 UNION SELECT 4,5,6) MINUS SELECT 4,5,6;
(SELECT 1,2,3 UNION SELECT 4,5,6 ORDER BY 1,2) MINUS SELECT 4,5,6;
