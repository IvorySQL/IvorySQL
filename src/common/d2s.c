 ...
 */
int
binary_double_to_shortest_decimal_bufn(double f, char *result)
{
	/*
	 * Step 1: Decode the floating-point number, and unify normalized and
	 * subnormal cases.
 ...
 */
int
binary_double_to_shortest_decimal_buf(double f, char *result)
{
	const int	index = binary_double_to_shortest_decimal_bufn(f, result);
