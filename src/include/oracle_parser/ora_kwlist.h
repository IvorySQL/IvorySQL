...
PG_KEYWORD("binary_double", BINARY_DOUBLE, COL_NAME_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
PG_KEYWORD("binary_float", BINARY_FLOAT, COL_NAME_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
...
PG_KEYWORD("byte", BYTE_P, COL_NAME_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
...
PG_KEYWORD("date", DATE_P, COL_NAME_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
...
PG_KEYWORD("decode", DECODE, COL_NAME_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
...
PG_KEYWORD("long", LONG_P, UNRESERVED_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
...
PG_KEYWORD("modify", MODIFY, UNRESERVED_KEYWORD, BARE_LABEL)	/* IvorySQL:sql-sequence */
...
PG_KEYWORD("noorder", NOORDER, UNRESERVED_KEYWORD, AS_LABEL)	/* IvorySQL:sql-sequence */
...
PG_KEYWORD("number", NUMBER_P, COL_NAME_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
PG_KEYWORD("numeric", NUMERIC, COL_NAME_KEYWORD, BARE_LABEL)
PG_KEYWORD("nvl", NVL, COL_NAME_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
PG_KEYWORD("nvl2", NVL2, COL_NAME_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
...
PG_KEYWORD("raw", RAW_P, UNRESERVED_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
...
PG_KEYWORD("userenv", USERENV, COL_NAME_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
...
PG_KEYWORD("varchar2", VARCHAR2, COL_NAME_KEYWORD, BARE_LABEL)	/* IvorySQL: datatype */
