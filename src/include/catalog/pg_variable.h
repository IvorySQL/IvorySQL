...
DECLARE_UNIQUE_INDEX_PKEY(pg_variable_oid_index, 562, VariableObjectIndexId, on pg_variable using btree(oid oid_ops));
DECLARE_UNIQUE_INDEX(pg_variable_varname_nsp_index, 563, VariableNameNspIndexId, on pg_variable using btree(varname name_ops, varnamespace oid_ops));
