 ...
 * ----------------
 */
CATALOG(pg_synonym,4546,SynonymRelationId)
{
		/* oid */
		Oid 		oid;
...
DECLARE_UNIQUE_INDEX_PKEY(pg_synonym_oid_index, 4547, on pg_synonym using btree(oid oid_ops));
#define SynonymOidIndexId 4547

DECLARE_UNIQUE_INDEX(pg_synonym_synonymname_nsp_synpub_index, 4548, on pg_synonym using btree(synname name_ops, synnamespace oid_ops, synispub bool_ops));
#define SynonyNameNspmpubIndexId 4548
