...
DECLARE_UNIQUE_INDEX_PKEY(pg_package_oid_index, 565, on pg_package using btree(oid oid_ops));
#define PackageObjectIndexId 565
DECLARE_UNIQUE_INDEX(pg_package_pkgname_nsp_index, 566, on pg_package using btree(pkgname name_ops, pkgnamespace oid_ops));
#define PackageNameNspIndexId 566
