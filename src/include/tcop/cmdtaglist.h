...
PG_CMDTAG(CMDTAG_ALTER_PACKAGE, "ALTER PACKAGE", true, false, false) /* ReqID:SRS-SQL-PACKAGE */
...
/* Begin - ReqID:SRS-SQL-PACKAGE */
PG_CMDTAG(CMDTAG_DISCARD_PACKAGES, "DISCARD PACKAGES", false, false, false)
/* End - ReqID:SRS-SQL-PACKAGE */
