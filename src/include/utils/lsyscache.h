...
extern Oid LookupSynonyms(char **synname, Oid *synschema, bool *reloidNotExistOk, Oid *mappingreloid);
extern Oid get_relid_by_synname(char **synname, char *synschemaname, Oid synnamespace);
extern bool get_funname_by_synname(char **synschema, char **synname, Oid synnamespace);
