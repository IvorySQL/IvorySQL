...
" SELECT pg_catalog.quote_ident(pkgname) "\
"   FROM pg_catalog.pg_package "\
"  WHERE substring(pg_catalog.quote_ident(pkgname),1,%d)='%s'"
...
static const pgsql_thing_t words_after_create[] = {
	...
	{"PACKAGE BODY", Query_for_list_of_packages, NULL, NULL, THING_NO_ALTER},
