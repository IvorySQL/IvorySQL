...
char *
ora_get_prompt(Ora_promptStatus_t status, ConditionalStack cstack)
{
#define MAX_PROMPT_SIZE 256
	...
	switch (status)
	{
		case ORAPROMPT_READY:
			prompt_string = pset.prompt1;
			break;

		case ORAPROMPT_CONTINUE:
		case ORAPROMPT_SINGLEQUOTE:
		case ORAPROMPT_DOUBLEQUOTE:
		case ORAPROMPT_DOLLARQUOTE:
		case ORAPROMPT_COMMENT:
		case ORAPROMPT_PAREN:
		case ORAPROMPT_QQUOTE:
