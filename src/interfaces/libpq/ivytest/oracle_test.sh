...
#
# Test driver for ivylib.  
# Initializes a new database, run testlibpq.
...
# Establish how the server will listen for incoming connections
testhost=`uname -s`
...
if [ "$1" = '--install' ]; then
	...
	# We need to make it to use psql from our temporary installation,
