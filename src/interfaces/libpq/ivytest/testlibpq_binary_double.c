/*-------------------------------------------------------------------------
 *
 * testlibpq_binary_double.c
 *
 * Test the C version of LIBPQ, the POSTGRES frontend library.  
 *
 * Portions Copyright (c) 2025, IvorySQL Global Development Team
 *
 * src/interfaces/libpq/ivytest/testlibpq_binary_double.c
 *
 *-------------------------------------------------------------------------
 */
...
char *function_str = "create or replace function test_binary_double(id integer,binary1 out binary_double, binary2 out binary_double[],binary3 binary_double) return binary_double as "
"  mds binary_double[3];"
" begin"
"     mds[0] := 3.1415926;"
"     mds[1] := 4.1415926;"
...
exec_prepare(Ivyconn *conn)
{
	...
	const char *stmt = "select * from test_binary_double($1,$2,$3,$4);";
	Oid param_types[4];
	IvyPreparedStatement *stmthandle;
	const char* custid = "200";
	const char* time1 = "6.1459";
	const char* time2 = "7.1459'";
	const char* time3 = "8.1459";
	...
	param_types[1] = 9524 | 0x40000000  /* out */;
	param_types[2] = 9525 | 0x40000000  /* out */;
	param_types[3] = 9524 | 0x20000000  /* in */;
...
main()
{
	...
	res = Ivyexec(conn, "drop function test_binary_double(integer, binary_double, binary_double[], binary_double);");
	Ivyclear(res);
