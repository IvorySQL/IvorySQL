...
Furthermore, for more detailed installation instructions, please refer to the [Installation Docs](https://docs.ivorysql.org/en/ivorysql-doc/v3.1/v3.1/3#installation). We provide four installation methods for IvorySQL, as outlined below:
- [Yum installation](https://docs.ivorysql.org/en/ivorysql-doc/v3.1/v3.1/3#Yum-installation)
- [Docker installation](https://docs.ivorysql.org/en/ivorysql-doc/v3.1/v3.1/3#Docker-installation)
- [Rpm installation](https://docs.ivorysql.org/en/ivorysql-doc/v3.1/v3.1/3#Rpm-installation)
- [Source code installation](https://docs.ivorysql.org/en/ivorysql-doc/v3.1/v3.1/3#Source-code-installation)
